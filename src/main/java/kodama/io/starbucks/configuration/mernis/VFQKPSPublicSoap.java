...
public class VFQKPSPublicSoap
{
    ...
    public VFQKPSPublicSoap(){}

    public VFQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VFQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VFQExtendedSoapSerializationEnvelope envelope= new VFQExtendedSoapSerializationEnvelope(VFQExtendedSoapSerializationEnvelope.VER11);
